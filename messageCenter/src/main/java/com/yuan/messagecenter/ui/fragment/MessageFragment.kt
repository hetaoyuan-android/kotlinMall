...
import com.yuan.messagecenter.R
...
class MessageFragment: BaseMvpFragment<MessagePresenter>(), MessageView {
    ...
    override fun injectComponent() {
        DaggerMessageComponent.builder().activityComponent(activtyComponent).messageModule(MessageModule()).build().inject(this)
